...
<head>
    ...
    <title>HamroFitness Invoice</title>
    <style>
    ...
    <table cellpadding="0" cellspacing="0" class="billing">
                ...
                @else
                    @if($settings->front_image != '')
                        @if($settings->local_storage == 0)
                            <img src="{{ $gymSettingPath.$settings->front_image }}" class="logo-default img-responsive image-change">
                        @else
                            <img src="{{ asset('/uploads/gym_setting/master/').'/'.$settings->front_image }}" class="logo-default img-responsive image-change">
                        @endif
                    @else
        ...
        <tr>
            ...
            <td id="company">
                ...
                <h2 class="name">{{ ucwords($customerBusiness->business->title) }}</h2>
                <div>@if(!is_null($customerBusiness->business->address)){!! nl2br($customerBusiness->business->address) !!}@endif</div>
                <div>@if(!is_null($customerBusiness->business->phone)){{ $customerBusiness->business->phone }}@endif</div>
                @if(!is_null($settings))
