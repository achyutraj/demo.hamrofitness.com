        ...
        <div class="portlet light ">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <div class="btn-group">
                        <a href="#"
                           class="btn sbold">Total: {{ $total_purchases }}
                        </a>
                        <a id="sample_editable_1_new"
                           href="{{route('gym-admin.client-purchase.user-create', $client->id)}}"
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <div class="btn-group">
                        <a href="#"
                           class="btn sbold">Total: {{ $total_reservations }}
                        </a>
                        <a id="sample_editable_1_new"
                           href="{{route('gym-admin.reservations.user-create', $client->id)}}"
                           class="btn sbold dark"> Add New
                            <i class="fa fa-plus"></i>
                        </a>
                    </div>
