                                    ...
                                    <th class="small-12 large-12 columns first last">
                                        <table>
                                            <tr>
                                                <th>
                                                    <center data-parsed="">
                                                        <a href="{{ route('ace.index') }}" align="center" class="text-center">
                                                            <img src="{{ $gymSettingPath.'fitness-plus.png' }}" class="swu-logo">
                                                        </a>
                                                    </center>
                                                </th>
                                                <th class="expander"></th>
                            ...
                            <table class="row masthead"><tbody><tr> <!-- Masthead -->
                                    <th class="small-12 large-12 columns first last">
                                        <table>
                                            <tr>
                                                <th>
                                                    <h1 class="text-center">Welcome to HamroFitness!</h1>
                                                    <center data-parsed="">
                                    ...
                                    <th class="small-12 large-12 columns first last">
                                        <table>
                                            <tr>
                                                <th>
                                                    <b><h5>Welcome!</h5></b>
                                                    <p>HamroFitness is a gym management software which is developed for the gym/fitness club owners through which they can manage their business on daily basis and cater their customers in a much better way. </p>
                                                    <br>
                                                    <b><h5>Features!</h5></b>
                                                    ...
                                                    <br>
                                                    <table class="button swu-button"><tr><td><table><tr><td><a href="{{ route('merchant.login.index').'?utm_source=ace_email&utm_medium=welcome_mail&utm_campaign=signin' }}">Go To Dashboard &raquo;</a></td></tr></table></td></tr></table>
                                                </th>
                                                <th class="expander"></th>
                                            </tr>
                                        </table>
                            ...
                            <table class="row grey"><tbody><tr>
                                    <th class="small-12 large-12 columns first last">
                                        <table>
                                            <tr>
                                                <th>
                                                    <p class="text-center footercopy">&#xA9; Copyright {{ \Carbon\Carbon::today('Asia/Kathmandu')->year }} HamroFitness. All Rights Reserved.</p>
                                                </th>
                                                <th class="expander"></th>
                                            </tr>
                                        </table>
