...
class StoreAdmsAttendanceLog extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'store:adms_attendance_log';
    ...
    {
        Log::info('Starting attendance log data first collection');

        $devices = Device::where('device_status',1)->orderBy('id','asc')->take(40)->get();
