...
<table class="body">
    <tr>
        <td class="center" align="center" valign="top">
            <!-- BEGIN: Header -->
            <table class="page-header" bgcolor="#1f1f1f" align="center">
                <tr>
                    <td class="center" align="center">
                        <!-- BEGIN: Header Container -->
                        <table class="container" width="650px" align="center">
                            <tr>
                                <td>
                                    <table class="row ">
                                        <tr>
                                            <td style="padding: 10px 20px 0px 0px;position: relative" width="280">
                                                <!-- BEGIN: Logo -->
                                            ...
                                            {{--<td class="wrapper vertical-middle last" style="padding-right: 0px" width="280">--}}
                                                {{--<!-- BEGIN: Social Icons -->--}}
                                                {{--<table class="six columns" style="margin: 0 auto">--}}
                                                    {{--<tr>--}}
                                                        {{--<td>--}}
                                                            {{--<table class="wrapper social-icons" style="float: right" align="right">--}}
                                                                {{--<tr>--}}
            ...
            <!-- END: Header -->
            <!-- BEGIN: Content -->
            <table class="container content" width="580px" align="center">
                <tr>
                    <td>
                                ...
                                @if($url != NULL && $url != '')
                                    <!-- BEGIN: Note Panel -->
                                        <table class="twelve columns" style="margin-bottom: 10px">
                                            <tr>
                                                <td class="panel" style="background: #ECF8FF;padding: 10px !important">
                                                    <a style="color: #2ba6cb" href="{{ $url }}">{{ $url }}</a>
                                                </td>
                                                <td class="expander">
                                                </td>
                                            </tr>
                        ...
                        <span class="devider" style="border-bottom: 1px solid #eee; margin: 15px -15px">
				</span>
                        <table class="row">
                            <tr>
            ...
            <!-- END: Content -->
            <!-- BEGIN: Footer -->
            <table class="page-footer" style="background: #2f2f2f" width="650px" align="center">
                <tr>
                    <td class="center" align="center">
                        <table class="container" width="580px" align="center">
                            <tr>
                                <td>
                                    <!-- BEGIN: Unsubscribet -->
                                    <table class="row">
								...
								<i>This is a system generated email and reply is not required.</i>
                                    ...
                                    <table class="row">
                                        <tr>
                                            <td class="wrapper" style="padding: 10px 20px 0px 0px">
                                            ...
                                            <td class="wrapper last" style="padding-right: 0px">
                                                <table class="eight columns">
                                                    <tr>
                                                        <td style="padding: 0px 0px 10px;text-align: right;" class="vertical-middle align-reverse">
                                                            <a style="color: #2ba6cb;text-decoration: none;" href="{{ URL::to('about') }}">
                                                                About Us</a>
                                                            &nbsp; <a style="color: #2ba6cb;text-decoration: none;" href="{{ URL::to('privacy') }}">
                                                                Privacy Policy</a>
                                                            &nbsp; <a style="color: #2ba6cb;text-decoration: none;" href="{{ URL::to('terms-of-use') }}">
                                                                Terms of Use</a>
                                                        </td>
                                                    </tr>
                                                </table>
