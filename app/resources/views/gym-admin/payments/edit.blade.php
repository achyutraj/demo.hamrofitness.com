                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    <select  class="bs-select form-control" data-live-search="true" data-size="8" name="purchase_id" id="purchase_id">
                                       <option>{{ $payment->purchase->membership->title ?? '' }}  [{{ $payment->purchase->membership->duration }} {{ $payment->purchase->membership->duration_type }}]
                                        {{ $gymSettings->currency->acronym }} {{ $payment->purchase->membership->price}}</option>
                                    </select>
                            ...
                            <div id="onlyMembership" @if($payment->payment_type != null) style="display: none" @endif>
                                ...
                                <div class="form-group form-md-line-input " id="next_payment_div" style="display: none">
                                    <div class="input-group left-addon right-addon">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                        <input type="text" class="form-control date-picker" readonly name="next_payment_date" id="next_payment_date" @if($payment->next_date != null) value="{{date("m/d/Y",strtotime($payment->next_date))}}" @endif>
