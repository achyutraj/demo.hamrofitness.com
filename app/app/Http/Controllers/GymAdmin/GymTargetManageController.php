...
class GymTargetManageController extends GymAdminBaseController
{
    ...
    public function ajax_create()
    {
        ...
        $target = SetTarget::select('set_targets.title', 'target_type.type as targetType', 'set_targets.value', 'date', 'set_targets.id')
        ...
        return Datatables::of($target)
            ...
            ->addColumn('targetType', function ($row) {
                return $row->targetType;
            })
            ->editColumn('value', function ($row) {
                return $this->data['gymSettings']->currency->acronym.' '.$row->value;
            })
