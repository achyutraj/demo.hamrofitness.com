                    ...
                    response.messages.forEach(function(msg){
                        if (msg.status == "success") {
                            if (msg.action == "redirect") {
                                ...
                                if (typeof msg.message != "undefined") {
                                    showResponseMessage(msg.message, "success");
                                }
                            }
    ...
    a(["jquery"], function (a) {
        return function () {
            ...
            function o(b) {
                ...
                var i = null, j = a("<div/>"), k = a("<div/>"), l = a("<div/>"), m = a(g.closeHtml),
            ...
            var r, s, t = 0, u = {error: "error", info: "info", success: "success", warning: "warning"},
                v = {clear: h, remove: i, error: b, getContainer: c, info: d, options: {}, subscribe: e, success: f, version: "2.0.3", warning: g};
            return v
        }()
    })
