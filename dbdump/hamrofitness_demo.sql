...
<head>
  ...
  <title>s2.hostssdserver.com / localhost | phpMyAdmin 5.2.2</title>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/messages.php?l=en&v=5.2.2"></script>
...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en",server:"1",table:"",db:"",token:"7b5372215460547a4867634b5c7e4a4b",text_dir:"ltr",LimitChars:"50",pftext:"",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:true,rootPath:true,arg_separator:"&",version:"5.2.2",auth_type:"cpanel",user:"cpses_habi0bws3f"});
...
<div id='pma_navigation_tree_content'>
    ...
    <div class="block">
      <i class="first"></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.aGFtcm9maXRuZXNzX2RlbW8=" data-vpath="cm9vdA==.aGFtcm9maXRuZXNzX2RlbW8=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=hamrofitness_demo"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=hamrofitness_demo" title="Structure">hamrofitness_demo</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.aGFtcm9maXRuZXNzX2ZpdG5lc3M=" data-vpath="cm9vdA==.aGFtcm9maXRuZXNzX2ZpdG5lc3M=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=hamrofitness_fitness"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=hamrofitness_fitness" title="Structure">hamrofitness_fitness</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.aGFtcm9maXRuZXNzX2ZpdG5lc3Njcm0=" data-vpath="cm9vdA==.aGFtcm9maXRuZXNzX2ZpdG5lc3Njcm0=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=hamrofitness_fitnesscrm"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=hamrofitness_fitnesscrm" title="Structure">hamrofitness_fitnesscrm</a>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7b5372215460547a4867634b5c7e4a4b">
