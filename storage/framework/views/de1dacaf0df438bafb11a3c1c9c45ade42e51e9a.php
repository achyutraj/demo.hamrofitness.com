<div class="modal" tabindex="-1" id="addNewBranch" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('device.shifts.store')); ?>" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="time" class="form-control" name="from_time" placeholder="Enter From Time" required
                               value="<?php echo e(old('from_time')); ?>" required>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="time" class="form-control" name="to_time" placeholder="Enter To Time" required
                               value="<?php echo e(old('to_time')); ?>" required>
...
</div><?php /**PATH /var/www/stage.hamrofitness.com/public_html/resources/views/devices/shifts/create.blade.php ENDPATH**/ ?>