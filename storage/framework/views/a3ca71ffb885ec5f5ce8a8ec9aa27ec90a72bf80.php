                ...
                <div class="portlet-body">
                    <div class="row">
                        <div class="col-md-offset-2 col-md-5">
                            <?php echo Form::open(['id'=>'createBalanceReport','class'=>'ajax-form']); ?>
...
<?php $__env->startSection('footer'); ?>
    ...
    <script>
        ...
        $('#save-form').click(function(){
            ...
            $.easyAjax({
                url:"<?php echo e(route('gym-admin.balance-report.store')); ?>",
        ...
        function load_data_table(id,s,e){
            ...
            var url = "<?php echo e(route('gym-admin.balance-report.ajax-create',['#id','#s','#e'])); ?>";
        ...
        function load_mem_table(id,s,e){
            ...
            var url = "<?php echo e(route('gym-admin.balance-report.ajax-create-mem',['#id','#s','#e'])); ?>";
            url = url.replace('#id',id);
            url = url.replace('#s',s);
            url = url.replace('#e',e);
            // begin first table
        ...
        function load_product_table(id,s,e){
            ...
            var url = "<?php echo e(route('gym-admin.balance-report.ajax-create-product',['#id','#s','#e'])); ?>";
            url = url.replace('#id',id);
            url = url.replace('#s',s);
            url = url.replace('#e',e);
            // begin first table
        ...
        function load_locker_table(id,s,e){
            ...
            var url = "<?php echo e(route('gym-admin.balance-report.ajax-create-locker',['#id','#s','#e'])); ?>";
            url = url.replace('#id',id);
            url = url.replace('#s',s);
            url = url.replace('#e',e);
            // begin first table
        ...
        function load_income_table(id,s,e){
            ...
            var url = "<?php echo e(route('gym-admin.balance-report.ajax-create-income',['#id','#s','#e'])); ?>";
            url = url.replace('#id',id);
            url = url.replace('#s',s);
            url = url.replace('#e',e);
            // begin first table
...
<?php echo $__env->make('layouts.gym-merchant.gymbasic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/stage.hamrofitness.com/public_html/resources/views/gym-admin/reports/balance/index.blade.php ENDPATH**/ ?>