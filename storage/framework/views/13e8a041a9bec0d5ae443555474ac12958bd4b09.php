        ...
        <div class="page-content-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="m-heading-1 border-green m-bordered">
                        ...
                        <p>This report section provides you list of locker reservation . </p>
                    </div>
                </div>
            </div>
            ...
            <div class="portlet light portlet-fit">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-calendar font-red"></i><span class="caption-subject font-red bold uppercase">Reservation Report</span></div>
                </div>
                <div class="portlet-body">
                    <div class="row">
                        <div class="col-md-offset-2 col-md-5">
                            <?php echo Form::open(['id'=>'createBookingReport','class'=>'ajax-form']); ?>
            ...
            <div class="row" id="bookingDataTable" style="display: none">
                <div class="col-md-12">
                    ...
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            <table class="table-100 table table-striped table-bordered table-hover order-column responsive" id="bookings_table">
                                <thead>
                                <tr>
...
<?php $__env->startSection('footer'); ?>
    ...
    <script>
        $('#save-form').click(function(){
            ...
            $.easyAjax({
                url: "<?php echo e(route('gym-admin.reservation-report.store')); ?>",
                container:'#createBookingReport',
                type:"POST",
                data:{date_range:dateRange,_token:'<?php echo e(csrf_token()); ?>'},
                success:function(res){
                    if(res.status = 'success'){
                        ...
                        download_book_data(res.start_date,res.end_date);
                        $('.counter').counterUp();
                    }
                }
            });
    ...
    <script>
        function load_data_table(s,e){
            ...
            var url = "<?php echo e(route('gym-admin.reservation-report.ajax-create',['#s','#e'])); ?>";
            url = url.replace('#s',s);
            url = url.replace('#e',e);
            // begin first table
            table.DataTable({
        ...
        function download_book_data(s,e){
            $('.downloadBooking').on('click',function(){
                window.location = 'reservation-report/download/'+ s + '/' + e;
            });
            $('.downloadExcelBooking').on('click',function(){
                window.location = 'reservation-report/download/excel/'+ s + '/' + e;
            });
        }
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.gym-merchant.gymbasic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/stage.hamrofitness.com/public_html/resources/views/gym-admin/reports/reservation/index.blade.php ENDPATH**/ ?>