                    ...
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            ...
                            <div id="select-recipient-section" >
                                ...
                                <?php echo Form::open(['id'=>'generateICardForm','class'=>'ajax-form']); ?>
...
<?php $__env->startSection('footer'); ?>
    ...
    <script>
        ...
        $('#generate-submit').click(function () {
            $.easyAjax({
                'url': "<?php echo e(route('gym-admin.i-card.store')); ?>",
        ...
        function load_data_table(id){
            ...
            var url = "<?php echo e(route('gym-admin.i-card.clientList',['#id'])); ?>";
        ...
        $('#email-qrcode').click(function () {
            $.easyAjax({
                'url': "<?php echo e(route('gym-admin.i-card.email-qr-code')); ?>",
                'container':"#generateICardForm",
                'type':'POST',
                'data':$('#generateICardForm').serialize(),
                success: function (response) {
...
<?php echo $__env->make('layouts.gym-merchant.gymbasic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/stage.hamrofitness.com/public_html/resources/views/gym-admin/i-card/index.blade.php ENDPATH**/ ?>