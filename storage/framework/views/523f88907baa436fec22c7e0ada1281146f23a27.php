<div class="modal" tabindex="-1" id="addNewDevice" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('device.info.store')); ?>" method="POST">
...
</div><?php /**PATH /var/www/stage.hamrofitness.com/public_html/resources/views/devices/device_info/create.blade.php ENDPATH**/ ?>