...
<?php $__env->startSection('footer'); ?>
    ...
    <script>
        $('#save-form').click(function(){
            ...
            if(booking == '')
            {
                ...
                $.easyAjax({
                    url:"<?php echo e(route('gym-admin.booking-report.store')); ?>",
                    container:'#createBookingReport',
                    type:"POST",
                    data:{date_range:dateRange,booking_type:booking,membership:membership,_token:'<?php echo e(csrf_token()); ?>'},
    ...
    <script>
        function load_data_table(id,s,e,membership){
            ...
            var url = "<?php echo e(route('gym-admin.booking-report.ajax-create',['#id','#s','#e','#membership'])); ?>";
...
<?php echo $__env->make('layouts.gym-merchant.gymbasic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/stage.hamrofitness.com/public_html/resources/views/gym-admin/reports/booking/index.blade.php ENDPATH**/ ?>