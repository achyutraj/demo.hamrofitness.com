...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="<?php echo e(route('gym-admin.product-payments.index')); ?>">Product Payments</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                    ...
                    <div class="portlet light portlet-fit">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input ">
                                    <select class="bs-select form-control" data-live-search="true" data-size="8" name="client" id="client">
                                        ...
                                        <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($client->id); ?>" <?php if(isset($product_sale) && $product_sale->client_id == $client->id): ?> selected <?php endif; ?>><?php echo e($client->fullName); ?> </option>
                                ...
                                <?php if(isset($userProductSale) && $userProductSale): ?>
                                    <?php
                                        $product_name = '';
                                        $arr['product_name'] = json_decode($product_sale->product_name,true);
                                    ...
                                    <div class="form-group form-md-line-input ">
                                        <select class="form-control" name="product_sale_id" id="product_sale_id">
                                            <option value="<?php echo e($product_sale->id); ?>"><?php echo e($product_name); ?> - [Purchased on: <?php echo e($product_sale->created_at->format('d-M')); ?>]</option>
                                        </select>
                                ...
                                <div id="remaining_div">
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        <div class="input-group left-addon right-addon">
                                            <span class="input-group-addon"><?php echo e($gymSettings->currency->acronym); ?></span>
                                            <input disabled type="number" min="0" class="form-control" name="remaining_amount" value="<?php echo e($amount ?? 0); ?>" id="remaining_amount">
                                            <input disabled type="hidden" class="form-control" name="remaining_amount_store" value="<?php echo e($amount ?? 0); ?>" id="remaining_amount_store">
                                            <span class="input-group-addon">.00</span>
                                ...
                                <div class="form-group form-md-line-input ">
                                    <div class="input-group left-addon right-addon">
                                        ...
                                        <input type="text" class="form-control date-picker" readonly name="payment_date" id="payment_date"
                                               value="<?php echo e(\Carbon\Carbon::now('Asia/Kathmandu')->format('m/d/Y')); ?>">
                                ...
                                <div id="onlyMembership">
                                    ...
                                    <div class="form-group form-md-line-input " id="next_payment_div">
                                        <div class="input-group left-addon right-addon">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            <input type="text" class="form-control date-picker" readonly name="next_payment_date" value="<?php echo e(\Carbon\Carbon::today()->addDays(1)->format('m/d/Y')); ?>" id="next_payment_date">
                            ...
                            <div class="form-actions" style="margin-top: 70px">
                                <div class="row">
                                    <div class="col-md-12">
                                        <button type="button" class="btn btn-success mt-ladda-btn ladda-button" data-style="zoom-in" id="save-form">
                                            <span class="ladda-label"><i class="fa fa-save"></i> SAVE</span>
                                        </button>
                                        <a href="<?php echo e(route('gym-admin.product-payments.index')); ?>" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        <?php echo Form::close(); ?>
...
<?php $__env->startSection('footer'); ?>
    ...
    <script>
        ...
        $("#client").on("change", function () {
            ...
            var url = "<?php echo e(route('gym-admin.product-payments.clientProductPurchases',[':id'])); ?>";
        ...
        $('#storePayments').on('change', '#product_sale_id', function () {
            var price = $('#product_sale_id :selected').data('price');
            $('#payment_amount').val(0);
    ...
    <script>
        $('#save-form').click(function () {
            ...
            $.easyAjax({
                url: "<?php echo e(route('gym-admin.product-payments.store')); ?>",
...
<?php echo $__env->make('layouts.gym-merchant.gymbasic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/stage.hamrofitness.com/public_html/resources/views/gym-admin/products/payments/create.blade.php ENDPATH**/ ?>