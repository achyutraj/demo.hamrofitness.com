                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-6 input-icon right">
                                        <input type="text" class="form-control" placeholder="First Name"
                                               name="first_name" id="fisrt_name" value="<?php echo e($user->first_name); ?>">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-6 input-icon right">
                                        <input type="text" class="form-control" placeholder="Middle Name"
                                               name="middle_name" id="middle_name" value="<?php echo e($user->middle_name); ?>">
                                        <div class="form-control-focus"></div>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-6 input-icon right">
                                        <input type="tel" class="form-control" placeholder="Mobile number" id="mobile"
                                               name="mobile" value="<?php echo e($user->mobile); ?>">
                                        <div class="form-control-focus"></div>
                                        ...
                                        <div class="input-icon right">
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail"
                                                    ...
                                                    <?php if($user->image == ''): ?>
                                                        <img id="changeProfile"
                                                             src="<?php echo e(asset('/fitsigma/images/').'/'.'user.svg'); ?>"
                                                             alt=""/>
                                                    <?php else: ?>
                                                        <img id="changeProfile"
                                                                 src="<?php echo e($profileHeaderPath.$user->image); ?>" alt=""/>
                                                    <?php endif; ?>
                                                </div>
                                                ...
                                                <div>
                                                    <?php if($user->image == ""): ?>
                                                        <button class="btn blue" rel="upload" onclick="forImage(this)">Upload
                                                            Image
                                                        </button>
                                                    <?php else: ?>
                                                        <button class="btn blue" rel="change" onclick="forImage(this)">Change
                                                            Image
                                                        </button>
                                                    <?php endif; ?>
                                ...
                                <div class="form-group form-md-line-input ">
                                    ...
                                    <div class="col-md-6 input-icon right">
                                        <input type="password" class="form-control"
                                               placeholder="Leave blank to keep current password" id="password"
                                               name="password">
...
<?php $__env->startSection('footer'); ?>
    ...
    <?php echo $__env->make('gym-admin.profile.webcam', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.gym-merchant.gymbasic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/stage.hamrofitness.com/public_html/resources/views/gym-admin/profile/profile.blade.php ENDPATH**/ ?>