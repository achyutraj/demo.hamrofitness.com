<script>
    ...
    $('#save-webcam-image').click(function () {
        ...
        var uploadUrl = '<?php echo e(route("gym-admin.profile.save-webcam-image", [ $user->id ])); ?>';
        $.easyAjax({
            url : uploadUrl,
            type: 'POST',
...
<?php /**PATH /var/www/stage.hamrofitness.com/public_html/resources/views/gym-admin/profile/webcam.blade.php ENDPATH**/ ?>