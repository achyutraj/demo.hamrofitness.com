                ...
                <div class="col-md-12">
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            ...
                            <?php echo Form::open(['route'=>'gym-admin.superadmin.store','id'=>'managerStoreForm','class'=>'ajax-form form-horizontal','method'=>'POST','files' => true]); ?>
                                ...
                                <div class="form-body">
                                    <ul class="nav nav-pills nav-justified steps">
                                        <?php if(isset($branch_id)): ?>
                                            <li>
                                                <a href="<?php echo e(route('gym-admin.superadmin.branch', [$branch_id])); ?>" class="step">
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <input type="text" class="form-control" name="first_name"
                                                   <?php if(!is_null($managerData)): ?> value="<?php echo e($managerData->first_name); ?>" <?php endif; ?>>
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <input type="text" class="form-control" name="middle_name"
                                                   <?php if(!is_null($managerData)): ?> value="<?php echo e($managerData->middle_name); ?>" <?php endif; ?>>
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <input type="text" class="form-control" name="last_name" id="last_name"
                                                   <?php if(!is_null($managerData)): ?> value="<?php echo e($managerData->last_name); ?>" <?php endif; ?>>
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <input type="text" class="form-control" name="email" id="email"
                                                   <?php if(!is_null($managerData)): ?> value="<?php echo e($managerData->email); ?>" <?php endif; ?>>
                                            ...
                                            <div class="md-radio-inline">
                                                <div class="md-radio">
                                                    <input type="radio" id="male" name="gender" value="male"
                                                           class="md-radiobtn"
                                                           <?php if(!is_null($managerData) && ($managerData->gender == 'male')): ?> checked <?php endif; ?>>
                                                    <label for="male">
                                                        <span></span>
                                                ...
                                                <div class="md-radio">
                                                    <input type="radio" id="female" name="gender" value="female"
                                                           class="md-radiobtn"
                                                           <?php if(!is_null($managerData) && ($managerData->gender == 'female')): ?> checked <?php endif; ?>>
                                                    <label for="female">
                                                        <span></span>
                                                        <span class="check"></span>
                                    ...
                                    <div class="form-group form-md-line-input mobile">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <input type="tel" class="form-control" id="mobile" name="mobile"
                                                   <?php if(!is_null($managerData) && isset($managerData->mobile)): ?> value="<?php echo e($managerData->mobile); ?>" <?php endif; ?>>
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <input type="text" class="form-control date-picker" placeholder="Birth Date"
                                                   ...
                                                   name="date_of_birth" id="date_of_birth" <?php if(!is_null($managerData) && isset($managerData->date_of_birth)): ?> value="<?php echo e($managerData->date_of_birth); ?>" <?php endif; ?>>
                                            <div class="form-control-focus"></div>
                                    ...
                                    <div class="form-group form-md-line-input ">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <input type="text" class="form-control" name="username"
                                                   <?php if(!is_null($managerData) && isset($managerData->username)): ?> value="<?php echo e($managerData->username); ?>" <?php endif; ?>>
...
<?php $__env->startSection('footer'); ?>
    ...
    <script>
        $('#storeManager').click(function () {
            $.easyAjax({
                url: "<?php echo e(route('gym-admin.superadmin.storeManagerPage')); ?>",
...
<?php echo $__env->make('layouts.gym-merchant.gymbasic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/stage.hamrofitness.com/public_html/resources/views/gym-admin/super-admin/create-branches/manager.blade.php ENDPATH**/ ?>