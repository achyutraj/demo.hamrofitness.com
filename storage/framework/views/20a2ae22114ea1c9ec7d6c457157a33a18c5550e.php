        ...
        <div class="row">
            <div class="col-md-3 col-sm-3 col-xs-3">
                <ul class="nav nav-tabs tabs-left">
                    <li>
                        <a href="<?php echo e(route('gym-admin.setting.index')); ?>"> Gym Logo </a>
                    </li>
                    <li>
                        ...
                        <div class="form-body col-md-6 col-md-offset-1">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="input-icon right">
                                    <input type="number" class="form-control" placeholder="Show Subscription Expire Day Before" id="subscription_expire_days" name="subscription_expire_days" value="<?php echo e($options['subscription_expire_days'] ?? 45); ?>">
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="input-icon right">
                                    <input type="number" class="form-control" placeholder="Show Product Expire Day Before" id="product_expire_days" name="product_expire_days" value="<?php echo e($options['product_expire_days'] ?? 45); ?>">
                                    <div class="form-control-focus"> </div>
                                    <span class="help-block">Enter Expire Day</span>
                                </div>
                            </div>
...
<?php echo $__env->make('gym-admin.setting.master-setting', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/stage.hamrofitness.com/public_html/resources/views/gym-admin/setting/other.blade.php ENDPATH**/ ?>