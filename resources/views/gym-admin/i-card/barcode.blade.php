                    ...
                    <div class="portlet light ">
                        <div class="portlet-title no-print">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject font-red bold uppercase"> Generate Barcode</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                                ...
                                <div class="row">
                                    <div class="col-md-offset-8 col-md-4 text-right">
                                        <a href="javascript:;" class="btn green btn-lg "
                                           id="generate-submit"><i class="fa fa-send"></i> Generate Barcodes</a>
                                    </div>
                                </div>
                            ...
                            <div id="i-card-generate" style="display: none">
                                ...
                                <h3 class="no-print">View Barcodes</h3>
...
@section('footer')
    ...
    <script>
        ...
        $('#generate-submit').click(function () {
            $.easyAjax({
                'url': "{{ route('gym-admin.barcode.store') }}",
        ...
        function load_data_table(id){
            ...
            var url =  "{{route('gym-admin.barcode.clientList',['#id'])}}";
        ...
        $('#email-qrcode').click(function () {
            $.easyAjax({
                'url': "{{ route('gym-admin.barcode.email-barcode') }}",
                'container':"#generateICardForm",
                'type':'POST',
                'data':$('#generateICardForm').serialize(),
                success: function (response) {
