                ...
                <div class="col-md-12">
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            ...
                            {{ html()->form->open(['route'=>'gym-admin.superadmin.storeRolePage','id'=>'roleStoreForm','class'=>'ajax-form form-horizontal','method'=>'POST','files' => true]) !!}
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <select class="form-control todo-taskbody-tags" name="role">
                                                ...
                                                <option class="todo-username pull-left" value="{{$role->name}}">{{$role->name}}</option>
                                            </select>
