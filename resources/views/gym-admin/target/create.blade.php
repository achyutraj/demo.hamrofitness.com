            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="m-heading-1 border-green m-bordered">
                        <h3>Targets</h3>
                        <p>Goal setting is an effective tool for progressive businesses, because it provides a sense of direction and purpose.</p>
                        <p> Set a goal for you now.</p>
                    </div>
                </div>
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-md-line-input">
                                            <div class="input-icon">
                                                <input type="text" readonly class="form-control date-picker" placeholder="Select End Date" name="date" id="date" >
