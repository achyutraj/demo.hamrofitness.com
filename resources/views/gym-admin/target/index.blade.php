...
@section('CSS')
    <link rel="stylesheet" href="{{ asset("admin/global/plugins/select2/select2.css") }}">
    <link rel="stylesheet" href="{{ asset("admin/global/plugins/select2/select2-bootstrap.css") }}">
