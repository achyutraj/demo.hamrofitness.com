                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-8 col-sm-8">
                                                                    <div class="todo-taskbody-user">
                                                                        ...
                                                                        @else
                                                                            <img src="{{$profileHeaderPath.$user->image}}" class="todo-userpic pull-left" width="50px" height="50px"/>
                                                                        @endif
                                                                        <span class="todo-username pull-left">{{ $user->first_name }} {{ $user->middle_name }} {{ $user->last_name }}</span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="input-icon">
                                                                        ...
                                                                        <input type="text" id="deadline" readonly name="deadline" data-date-today-highlight="true" class="form-control todo-taskbody-due" placeholder="Due Date..."> </div>
                                                                </div>
                                                            </div>
    ...
    @section('footer')
        ...
        <script src="{{ asset("admin/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js") }}"></script>
