                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-wizard">
                                <div class="form-body">
                                    ...
                                    <div class="form-group form-md-line-input">
                                        <label class="col-md-2 control-label" for="form_control_1">Middle Name <span class="required" aria-required="true"> * </span></label>

                                        <div class="col-md-6 input-icon right">
                                            <input type="text" class="form-control" name="middle_name"
                                                   id="middle_name" value="{{$user->middle_name}}">
...
@section('footer')
    ...
    <script>
        $('#updateProfile').click(function () {
            $.easyAjax({
                url: '{{route('gym-admin.account-setup.profileStore')}}',
