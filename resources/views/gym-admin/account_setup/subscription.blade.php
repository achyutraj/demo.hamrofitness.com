                            ...
                            <div class="form-body">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-md-line-input ">
                                            <div class="input-group left-addon right-addon">
                                                <span class="input-group-addon">{{--{{ $gymSettings->currency->acronym }}--}}Rs</span>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group form-md-line-input ">
                                            <div class="input-icon">
                                                <input type="text" value="@if(!is_null($subscription) && isset($subscription->purchase_date)) {{ $subscription->purchase_date->format('m/d/Y') }} @else {{ \Carbon\Carbon::today('Asia/Kathmandu')->format('m/d/Y') }} @endif" class="form-control date-picker" placeholder="Select Purchase Date" name="purchase_date" readonly id="purchase_date">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-md-line-input">
                                            <div class="input-icon">
                                                <input type="text" value="@if(!is_null($subscription) && isset($subscription->start_date)) {{ $subscription->start_date->format('m/d/Y') }} @else {{ \Carbon\Carbon::today('Asia/Kathmandu')->format('m/d/Y') }} @endif" class="form-control date-picker" readonly  name="start_date" id="start_date">
