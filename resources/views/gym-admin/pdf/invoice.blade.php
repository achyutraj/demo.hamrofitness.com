                ...
                @else
                    @if($settings->front_image != '')
                        @if($settings->local_storage == '0')
                            {{ html()->img($gymSettingPath.$settings->front_image, 'Hamrofitness')->attributes(array('class' => 'img-responsive inline-block', 'style' => 'height: 60px;')) }}
                        @else
                            {{ html()->img(asset('/uploads/gym_setting/master/').'/'.$settings->front_image, 'Hamrofitness')->attributes(array('class' => 'img-responsive inline-block', 'style' => 'height: 60px;')) }}
                        @endif
                    @else
                        {{ html()->img(asset('/uploads/gym_setting/master/').'/'.$settings->image, 'Hamrofitness')->attributes(array('class' => 'img-responsive inline-block', 'style' => 'height: 60px;')) }}
                    @endif
                @endif
            </td>
        </tr>
