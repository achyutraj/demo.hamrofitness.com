...
@section('content')
    <div class="container-fluid">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="{{ route('gym-admin.membership-plans.index') }}">Membership</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                ...
                <div class="col-md-10 col-xs-12">
                    ...
                    <div class="portlet light portlet-fit">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-pencil font-red"></i><span
                                    class="caption-subject font-red bold uppercase">Edit Membership Plan</span>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                <input type="text" class="form-control" value="{{ $membership->title }}"
                                                    name="title" id="title">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                <div class="input-group left-addon right-addon">
                                                    <span
                                                        class="input-group-addon">{{ $gymSettings->currency->acronym }}</span>
                                                    <input type="number" min="0" value="{{ $membership->price }}"
                                            ...
                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                <div class="input-group left-addon right-addon">
                                                    ...
                                                    <input type="text" class="form-control" min="0"
                                                        value="{{ $membership->duration }}" name="duration" id="duration">
                                                    <span class="help-block" id="membership_duration_error">Enter membership
                                                        duration.</span>
                                                    <span class="input-group-addon">.00</span>
                                                    <label for="duration"> Membership Duration <span class="required"
                                            ...
                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                <div class="input-group left-addon right-addon">
                                                    ...
                                                    <select class="form-control" id="duration_type" name="duration_type"
                                                        ...
                                                        <option value="minute"
                                                            @if ($membership->duration_type == 'minute') selected @endif>Minute
                                                        </option>
                                                        <option value="days"
                                                            @if ($membership->duration_type == 'days') selected @endif>Days</option>
                                                        <option value="month"
                                                            @if ($membership->duration_type == 'month') selected @endif>Month</option>
                                                        <option value="year"
                                                            @if ($membership->duration_type == 'year') selected @endif>Year</option>
                                                        <option value="unlimited"
                                                            @if ($membership->duration_type == 'unlimited') selected @endif>Unlimited
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
            ...
            var handleValidation3 = function() {
                ...
                form1.validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        $.easyAjax({
                            url: "{{ route('gym-admin.membership-plans.update', [$membership->id]) }}",
