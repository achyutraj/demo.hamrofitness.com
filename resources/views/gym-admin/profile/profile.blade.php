                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-6 input-icon right">
                                        <input type="text" class="form-control" placeholder="First Name"
                                               name="first_name" id="fisrt_name" value="{{$user->first_name}}">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-6 input-icon right">
                                        <input type="text" class="form-control" placeholder="Middle Name"
                                               name="middle_name" id="middle_name" value="{{$user->middle_name}}">
                                        <div class="form-control-focus"></div>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-6 input-icon right">
                                        <input readonly name="date_of_birth" id="date_of_birth" type="text"
                                               ...
                                               value="@if(!is_null($user->date_of_birth)){{ \Carbon\Carbon::createFromFormat('Y-m-d', $user->date_of_birth)->format('Y-m-d')}}@endif">
                                        <div class="form-control-focus"></div>
                                        ...
                                        <div class="input-icon right">
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail"
                                                    ...
                                                    @else
                                                        <img id="changeProfile"
                                                                 src="{{$profileHeaderPath.$user->image}}" alt=""/>
                                                    @endif
                                                </div>
...
@section('footer')
    ...
    @include('gym-admin.profile.webcam')
@stop
