                                ...
                                <div class="todo-content">
                                    <div class="portlet light ">
                                        ...
                                        <div class="portlet-title">
                                            ...
                                            <div class="actions">
                                                <div class="btn-group">
                                                    <a class="btn green  btn-sm" href="javascript:;" data-toggle="dropdown" data-hover="dropdown" data-close-others="true"> Filters
                                            ...
                                            <div class="actions sort-distance">
                                                <div class="btn-group">
                                                    <a class="btn green  btn-sm" href="javascript:;" data-toggle="dropdown" data-hover="dropdown" data-close-others="true"> Sort By
                                                        <i class="fa fa-angle-down"></i>
                                                    </a>
                                                    <ul class="dropdown-menu pull-right">
                                                        <li onclick="sortBy()">
                                                    ...
                                                    <form id="create-edit-task" class="form-horizontal">
                                                        ...
                                                        <div class="form">
                                                            <div class="form-group">
                                                                <div class="col-md-8 col-sm-8">
                                                                    <div class="todo-taskbody-user">
                                                                        ...
                                                                        <select class="form-control todo-taskbody-tags" id="employName" name="employ_id">
                                                                            <option></option>
                                                                            @foreach($employees as $employ)
                                                                                <option class="todo-username pull-left" value="{{$employ->id}}">{{$employ->fullName}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4 col-sm-4 add-task-btn">
                                                                    <div class="todo-taskbody-date pull-right">
                                                                        <button type="button" class="todo-username-btn btn  btn-default btn-sm" onclick="addTask();return false;">&nbsp; Add Task <i class="fa fa-plus"></i> &nbsp;</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- END TASK HEAD -->
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="input-icon">
                                                                        ...
                                                                        <input type="text" id="deadline" readonly name="deadline" class="form-control todo-taskbody-due date-picker" data-date-today-highlight="true" placeholder="Due Date..."> </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-actions right todo-form-actions">
                                                                <button class="btn  btn-sm green" id="add-update-btn" onclick="addUpdate();return false;">Save Changes</button>
    ...
    @section('footer')
        ...
        <script>
            ...
            function taskLoad(page) {
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{ route('gym-admin.employTask.loadmoretask') }}",
                    cache: false,
                    data: {
                        'page': page,
                        'data': data,
            ...
            function show(id) {
                var url = "{{ route('gym-admin.employTaskList.edit',':id') }}";
                ...
                $.easyAjax({
                    ...
                    success: function(response) {
                        ...
                        $('#employName').val(data.employ_id).trigger('change');
            ...
            function addUpdate() {
                ...
                var url;
                if(id == '') {
                    url = "{{ route('gym-admin.employTaskList.store') }}";
                } else {
                    url = "{{ route('gym-admin.employTaskList.update',':id') }}";
                    url = url.replace(':id',id);
                }
                ...
                $.easyAjax({
                    ...
                    success: function(response) {
                        if(response.status == 'success') {
                            $('#employName').prop('selectedIndex',1).trigger('change');
                            $('#heading').val('');
                            $('#description').val('');
                            $('#deadline').val('');
            ...
            function deleteTask(id) {
                ...
                var url = "{{ route('gym-admin.employTaskList.destroy',':id') }}";
                url = url.replace(':id',id);
