                                ...
                                <div class="input-icon right">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                            @if($merchantSetting == '')
                                                <img id="changeProfile" src="{{ asset('/fitsigma/images/').'/'.'fitness-plus.png' }}" alt="" />
                                            @elseif($merchantSetting->image == '')
                                                <img src="{{ asset('/fitsigma/images/').'/'.'fitness-plus.png' }}" alt="" />
                                            @else
                            ...
                            <div class="form-group form-md-line-input hidden-xs hidden-sm">
                                ...
                                <div class="input-icon right">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                            @if($merchantSetting == '')
                                                <img id="customerImage" src="{{ asset('/fitsigma/images/').'/'.'fitness-plus.png' }}" alt="" />
