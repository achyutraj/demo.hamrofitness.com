        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
                <div class="tab-content">
                    {{ html()->form->open(['route'=>'gym-admin.setting.storeMailCredentials','id'=>'footerCredentialForm','class'=>'ajax-form form-horizontal','method'=>'POST','files' => true]) !!}
                    <div class="form-body col-md-6 col-md-offset-1">
                        <div class="form-group form-md-line-input">
                            <label class="control-label" for="form_control_1">About</label>
                            <div class="input-icon right">
                                <textarea class="form-control" name="about"
                                          id="about">@if($merchantSetting != ''){{$merchantSetting->about}}@endif</textarea>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="input-icon right">
                                <input type="text" class="form-control" placeholder="Facebook URL" id="fb_url" name="fb_url"
                                       value="@if($merchantSetting !='') {{ $merchantSetting->fb_url }} @endif">
                                <div class="form-control-focus"></div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="input-icon right">
                                <input type="text" class="form-control" placeholder="Google Plus URL" id="google_url" name="google_url"
                                       value="@if($merchantSetting !='') {{ $merchantSetting->google_url }} @endif">
                                <div class="form-control-focus"></div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="input-icon right">
                                <input type="text" class="form-control" placeholder="Twitter URL" id="twitter_url" name="twitter_url"
                                       value="@if($merchantSetting !='') {{ $merchantSetting->twitter_url }} @endif">
                                <div class="form-control-focus"></div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="input-icon right">
                                <input type="text" class="form-control" placeholder="Youtube URL" id="youtube_url" name="youtube_url"
                                       value="@if($merchantSetting !='') {{ $merchantSetting->youtube_url }} @endif">
                                <div class="form-control-focus"></div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="input-icon right">
                                <input type="text" class="form-control" placeholder="Contact Mail" id="contact_mail" name="contact_mail"
                                       value="@if($merchantSetting !='') {{ $merchantSetting->contact_mail }} @endif">
                                <div class="form-control-focus"></div>
