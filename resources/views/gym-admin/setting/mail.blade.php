...
@push('mail-styles')
    <style>
        .all-hide, .mail-credentials-hide {
            display: none;
        }
    </style>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-3 col-xs-3">
                <ul class="nav nav-tabs tabs-left">
                    ...
                    <li>
                        <a href="{{ route('gym-admin.setting.notification') }}"> Notifications </a>
                    </li>
                    <li>
                ...
                <div class="tab-content">
                    ...
                    <div class="form-body col-md-6 col-md-offset-1">
                        <div class="form-group form-md-line-input">
                            <label class="control-label" for="form_control_1">Email Status</label>
                            <select class="form-control" name="email_status">
                                <option @if($merchantSetting !='' && $merchantSetting->email_status == 'enabled') selected @endif value="enabled">
                                    Enabled
                                </option>
                                <option @if($merchantSetting !='' && $merchantSetting->email_status == 'disabled') selected @endif value="disabled">
                                    Disabled
                                </option>
                            </select>
                            <div class="form-control-focus"></div>
                        </div>
                        <div class="all form-group form-md-line-input @if($merchantSetting !='' && $merchantSetting->email_status == 'disabled') all-hide @endif">
                        ...
                        <div class="form-group form-md-line-input mail-credentials @if($merchantSetting !='' && $merchantSetting->mail_driver == 'mail') mail-credentials-hide @elseif($merchantSetting->email_status == 'disabled') mail-credentials-hide @endif">
                            <label class="control-label" for="form_control_1">Mail Host</label>
                            <div class="input-icon right">
                                <input type="text" class="form-control" placeholder="Mail Host" id="mail_host" name="mail_host"
                                       value="@if($merchantSetting !=''){{ $merchantSetting->mail_host }}@endif">
                                <div class="form-control-focus"></div>
                        ...
                        <div class="form-group form-md-line-input mail-credentials @if($merchantSetting !='' && $merchantSetting->mail_driver == 'mail') mail-credentials-hide @elseif($merchantSetting->email_status == 'disabled') mail-credentials-hide  @endif">
                            ...
                            <div class="input-icon right">
                                <input type="text" class="form-control" placeholder="Mail Port" id="mail_port" name="mail_port"
                                       value="@if($merchantSetting !=''){{ $merchantSetting->mail_port }}@endif">
                                <div class="form-control-focus"></div>
                        ...
                        <div class="form-group form-md-line-input mail-credentials @if($merchantSetting !='' && $merchantSetting->mail_driver == 'mail') mail-credentials-hide @elseif($merchantSetting->email_status == 'disabled') mail-credentials-hide @endif">
                            ...
                            <div class="input-icon right">
                                <input type="text" class="form-control" placeholder="Mail Username" id="mail_username" name="mail_username"
                                       value="@if($merchantSetting !=''){{ $merchantSetting->mail_username }}@endif">
                                <div class="form-control-focus"></div>
                        ...
                        <div class="form-group form-md-line-input mail-credentials @if($merchantSetting !='' && $merchantSetting->mail_driver == 'mail') mail-credentials-hide @elseif($merchantSetting->email_status == 'disabled') mail-credentials-hide @endif">
                            ...
                            <div class="input-icon right">
                                <input type="text" class="form-control" placeholder="Mail Password" id="mail_password" name="mail_password"
                                       value="@if($merchantSetting !=''){{ $merchantSetting->mail_password }}@endif">
                                <div class="form-control-focus"></div>
                        ...
                        <div class="all form-group form-md-line-input @if($merchantSetting !='' && $merchantSetting->email_status == 'disabled') all-hide @endif">
                            ...
                            <div class="input-icon right">
                                <input type="text" class="form-control" placeholder="Mail From Name" id="mail_name" name="mail_name"
                                       value="@if($merchantSetting !=''){{ $merchantSetting->mail_name }}@endif">
                                <div class="form-control-focus"></div>
                        ...
                        <div class="all form-group form-md-line-input @if($merchantSetting !='' && $merchantSetting->email_status == 'disabled') all-hide @endif">
                            ...
                            <div class="input-icon right">
                                <input type="text" class="form-control" placeholder="Mail From Email" id="mail_email" name="mail_email"
                                       value="@if($merchantSetting !=''){{ $merchantSetting->mail_email }}@endif">
                                <div class="form-control-focus"></div>
...
@push('mail-scripts')
    <script>
        ...
        $('select[name=email_status]').change(function () {
            var status = $('select[name=email_status]').val();
            if (status == 'enabled') {
