                ...
                <div class="portlet-body">
                    <div class="row">
                        <div class="col-md-offset-2 col-md-5">
                            {{ html()->form->open(['id'=>'createFinanceReport','class'=>'ajax-form']) !!}
                            <div class="form-body">
...
@section('footer')
        ...
        $('#save-form').click(function(){
            ...
            if(type == ''){
                ...
                $.easyAjax({
                    ...
                    type:"POST",
                    data:{date_range:dateRange,type:type,payment_source:paymentType,_token:'{{csrf_token()}}'},
    ...
    <script>
        function load_data_table(id,s,e,paymentType){
            var table = $('#'+id);
            var url = "{{route('gym-admin.finance-report.ajax-create',['#id','#s','#e','#paymentType'])}}";
