                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light portlet-fit">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-plus font-red"></i><span class="caption-subject font-red bold uppercase">Add LockerNumber</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <!-- BEGIN FORM-->
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        <input type="text" class="form-control" name="locker_num" id="locker_num">
            ...
            var handleValidation3 = function() {
                ...
                form1.validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        error1.hide();
                        $.easyAjax({
                            url: "{{route('gym-admin.lockers.store')}}",
