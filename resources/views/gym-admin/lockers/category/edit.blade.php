...
@section('content')
    <div class="container-fluid"  >
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="{{ route('gym-admin.locker-category.index') }}">Locker Category</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>Edit LockerCategory</span>
            </li>
        </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light portlet-fit">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-pencil font-red"></i><span class="caption-subject font-red bold uppercase">Edit Locker</span>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                ...
                                                <label for="title">Locker Name</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="form-group form-md-radios">
                                                    <label>Locker Type <span class="required" aria-required="true"> * </span></label>
                                                    <div class="md-radio-inline">
                                                        <div class="md-radio">
                                                            <input
                                                                @if($package->type == "small")
                                                                    checked
                                                                @endif
                                                                type="radio" value="small" id="small" name="type" class="md-radiobtn">
                                                            <label for="small">
                                                                <span></span>
                                                                <span class="check"></span>
                                                                <span class="box"></span> Small </label>
                                                        </div>
                                                        <div class="md-radio ">
                                                            <input type="radio"
                                                                   @if($package->type == "medium")
                                                                       checked
                                                                   @endif

                                                                   value="medium" id="medium" name="type" class="md-radiobtn" >
                                                            <label for="medium">
                                                                <span></span>
                                                                <span class="check"></span>
                                                                <span class="box"></span> Medium </label>
                                                        </div>
                                                        <div class="md-radio">
                                                            <input type="radio"
                                                                   @if($package->type == "large")
                                                                       checked
                                                                   @endif

                                                                   value="large" id="large" name="type" class="md-radiobtn">
                                                            <label for="large">
                                                                <span></span>
                                                                <span class="check"></span>
                                                                <span class="box"></span> Large </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                <div class="input-group left-addon right-addon">
                                                    ...
                                                    <span class="help-block">Enter a month price.</span>
                                                    <span class="input-group-addon">.00</span>
                                                    <label for="price">1 Month Price <span class="required" aria-required="true"> * </span> </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                <div class="input-group left-addon right-addon">
                                                    <span class="input-group-addon">{{ $gymSettings->currency->acronym }}</span>
                                                    <input type="text" class="form-control" name="three_month_price" value="{{$package->three_month_price}}" id="three_month_price">
                                                    <span class="help-block">Enter three month price.</span>
                                                    <span class="input-group-addon">.00</span>
                                                    <label for="three_month_price">3 Month Price </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                <div class="input-group left-addon right-addon">
                                                    <span class="input-group-addon">{{ $gymSettings->currency->acronym }}</span>
                                                    <input type="text" class="form-control" name="six_month_price" value="{{$package->six_month_price}}" id="six_month_price">
                                                    <span class="help-block">Enter six month price.</span>
                                                    <span class="input-group-addon">.00</span>
                                                    <label for="six_month_price">6 Month Price </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                <div class="input-group left-addon right-addon">
                                                    <span class="input-group-addon">{{ $gymSettings->currency->acronym }}</span>
                                                    <input type="text" class="form-control" name="one_year_price" value="{{$package->one_year_price}}" id="one_year_price">
                                                    <span class="help-block">Enter one year price.</span>
                                                    <span class="input-group-addon">.00</span>
                                                    <label for="one_year_price">One Year Price </label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            var handleValidation3 = function() {
                ...
                form1.validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        error1.hide();
                        $.easyAjax({
                            url: "{{route('gym-admin.locker-category.update',$package->uuid)}}",
