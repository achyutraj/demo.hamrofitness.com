<div class="modal-header">
    ...
    <span class="caption-subject font-red-sunglo bold uppercase"><i class="icon-refresh"></i> Renew Reservation</span>
</div>
                ...
                <div class="form-body">
                    <div class="form-group form-md-line-input row">
                        ...
                        <div class="col-md-9">
                            <div class="form-control form-control-static">
                                ...
                                @else
                                    <img style="width:50px;height:50px;" class="img-circle" src="{{$profileHeaderPath.$reservation->client->image}}" alt="" />
                                @endif
                                {{ ucwords($reservation->client->first_name.' '.$reservation->client->middle_name.' '.$reservation->client->last_name) }}
                            </div>
                        </div>
                    </div>
                    <div class="form-group row form-md-line-input">
                        <label class="col-md-3 control-label">LockerNo.</label>
                        <div class="col-md-9">
                            <div class="form-control form-control-static">
                                    {{ ucwords($reservation->locker->locker_num) }}
                            </div>
                    ...
                    <div class="form-group form-md-line-input form-md-floating-label">
                        ...
                        <div class="col-md-9">
                            <div class="input-group left-addon right-addon">
                                ...
                                <input type="number" min="0" value="{{ $reservation->purchase_amount }}" class="form-control" name="purchase_amount" id="purchase_amount">
                    ...
                    <div class="form-group form-md-line-input form-md-floating-label">
                        ...
                        <div class="col-md-9">
                            <div class="input-group left-addon right-addon">
                                <span class="input-group-addon">{{ $gymSettings->currency->acronym }}</span>
                                <input type="number" value="{{ $reservation->purchase_amount }}" class="form-control" name="amount_to_be_paid" id="amount_to_be_paid" min="0">
                    ...
                    <div class="form-group form-md-line-input ">
                        ...
                        <div class="col-md-9">
                            <div class="input-icon">
                                ...
                                <div class="form-control-focus"> </div>
                                <span class="help-block">Add remark</span>
...
<script>
    ...
    $('#save-form').click(function(){
        ...
        var show_url = "{{route('gym-admin.reservations.renew-reservation-store',['#id'])}}";
        var url = show_url.replace('#id', '{{ $reservation->id }}');
