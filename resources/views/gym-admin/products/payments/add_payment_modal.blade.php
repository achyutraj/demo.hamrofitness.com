                ...
                <div class="form-body">
                    <div class="form-group form-md-line-input row">
                        ...
                        <div class="col-md-9">
                            <div class="form-control form-control-static">
                                {{ ucwords($purchase->customer_name) }}
                            </div>
                    ...
                    <div class="form-group row form-md-line-input">
                        ...
                        <div class="col-md-9">
                            <div class="form-control form-control-static">
                                @php
                                    $arr['product_name'] = json_decode($purchase->product_name,true);
                    ...
                    <div class="form-group form-md-line-input row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter amount" id="payment_amount" name="payment_amount">
                    ...
                    <div class="form-group form-md-line-input row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                <span class="input-group-addon">{{ $gymSettings->currency->acronym }} </span>
                                <input type="number" disabled class="form-control" placeholder="Enter amount" id="remaining_amount" name="remaining_amount" value="{{ ($purchase->total_amount - $purchase->paid_amount) }}">
                                <div class="form-control-focus"> </div>
                                <span class="input-group-addon">.00</span>
                            </div>
                    ...
                    <input type="hidden" id="remaining_amount_store" value="{{ ($purchase->total_amount - $purchase->paid_amount) }}">
                    ...
                    <div class="form-group form-md-radios">
                        ...
                        <div class="col-md-9">
                            <div class="md-radio-inline">
                                <div class="md-radio">
                                    <input type="radio" value="yes" id="yes_radio"  checked name="payment_required" class="md-radiobtn" >
                                    <label for="yes_radio">
                                        <span></span>
                                        <span class="check"></span>
                    ...
                    <div class="form-group form-md-line-input " id="next_payment_div" style="display: block">
                        ...
                        <div class="col-md-9">
                            <div class="input-group left-addon right-addon">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                <input type="text" class="form-control date-picker" value="{{ \Carbon\Carbon::today()->addDays(1)->format('m/d/Y') }}" name="next_payment_date" id="next_payment_date">
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $('#save-form').click(function(){
        ...
        if(type == 'yes' && $('#next_payment_date').val()=='')
        {
            ...
            $.easyAjax({
                url: "{{route('gym-admin.product-payments.ajax-payment-store', [$purchase->id])}}",
