                    ...
                    <div class="portlet light portlet-fit">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input ">
                                    <select class="bs-select form-control" data-live-search="true" data-size="8" name="client" id="client">
                                        ...
                                        @foreach($clients as $client)
                                            <option value="{{$client->id}}" @if(isset($product_sale) && $product_sale->client_id == $client->id) selected @endif>{{$client->fullName}} </option>
                                        @endforeach
                                    </select>
                                ...
                                @if(isset($userProductSale) && $userProductSale)
                                    @php
                                        $product_name = '';
                                    ...
                                    <div class="form-group form-md-line-input ">
                                        <select class="form-control" name="product_sale_id" id="product_sale_id">
                                            <option value="{{$product_sale->id}}">{{ $product_name }} - [Purchased on: {{$product_sale->created_at->format('d-M')}}]</option>
                                        </select>
                                ...
                                <div class="form-group form-md-line-input ">
                                    <div class="input-group left-addon right-addon">
                                        ...
                                        <input type="text" class="form-control date-picker" readonly name="payment_date" id="payment_date"
                                               value="{{ \Carbon\Carbon::now('Asia/Kathmandu')->format('m/d/Y') }}">
                                ...
                                <div id="onlyMembership">
                                    ...
                                    <div class="form-group form-md-line-input " id="next_payment_div">
                                        <div class="input-group left-addon right-addon">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            <input type="text" class="form-control date-picker" readonly name="next_payment_date" value="{{ \Carbon\Carbon::today()->addDays(1)->format('m/d/Y') }}" id="next_payment_date">
                            ...
                            <div class="form-actions" style="margin-top: 70px">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a href="{{route('gym-admin.product-payments.index')}}" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        {{ html()->form()->close() }}
...
@section('footer')
    ...
    <script>
        ...
        $("#client").on("change", function () {
            ...
            var url = "{{route('gym-admin.product-payments.clientProductPurchases',[':id'])}}";
    ...
    <script>
        $('#save-form').click(function () {
            ...
            $.easyAjax({
                url: "{{route('gym-admin.product-payments.store')}}",
