                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <p class="col-md-4">Subscription: </p>
                                    <p class="col-md-8">
                                        {{ ucwords($purchaseTitle) }} [{{ $purchase->membership->duration }} {{ $purchase->membership->duration_type }}]
                                        {{ $gymSettings->currency->acronym }} {{ $purchase->membership->price}} <span class="label label-info">{{ ucwords($purchase->membership->subCategory->category->name) }}</span>
                                    </p>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-md-line-input form-md-floating-label">
                                            <div class="input-group left-addon right-addon">
                                                ...
                                                <input type="text"  class="form-control" name="purchase_amount" id="purchase_amount" value="{{$purchase->purchase_amount}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-md-line-input">
                                            <div class="input-icon">
                                                <input type="text" readonly class="form-control date-picker" placeholder="Select Due Payment Date" name="next_payment_date" id="next_payment_date" value="{{isset($purchase->next_payment_date) ? $purchase->next_payment_date->format('m/d/Y') : ''}}">
