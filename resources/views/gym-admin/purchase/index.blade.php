                        ...
                        <div class="portlet-title">
                            ...
                            <div class="pull-right">
                                <div class="btn-group">
                                    ...
                                    <a href="{{route('gym-admin.client-purchase.inactive')}}" class="btn btn-info">
                                        Inactive
                                    </a>
                                    <a class="btn btn-warning add-pending-btn-gap" href="{{ route('gym-admin.client-purchase.pending-subscription') }}">
                                        Pending ({{ $pendingCount }})</a>
                                    <a class="btn btn-danger add-pending-btn-gap" href="{{ route('gym-admin.client-purchase.deleted-subscription') }}">
                                        Deleted ({{ $deletedCount }})</a>
...
@section('footer')
    ...
    <script>
        ...
        var table = clientTable.dataTable({
            processing: true,
            serverSide: true,
            ajax: "{{route('gym-admin.client-purchase.ajax-create',['type'=>'all'])}}",
            columns: [
