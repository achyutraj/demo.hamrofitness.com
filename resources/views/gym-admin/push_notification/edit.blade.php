...
@section('content')
    <div class="container-fluid"  >
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="{{ route('gym-admin.notifications.index') }}">Push Notification</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light portlet-fit">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-pencil font-red"></i><span class="caption-subject font-red bold uppercase">Edit Push Notification</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <!-- BEGIN FORM-->
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        <input type="text" class="form-control" name="url" id="url" value="{{ $notification->url ?? old('url') }}">
                                        <label for="url">URL</label>
                                    </div>
                                    

                                    <div class="form-group form-md-line-input ">
                                        <textarea class="form-control wysihtml5"  name="message" rows="3">{{ $notification->message }}</textarea>
                                        <label for="message">Message <span class="required" aria-required="true"> * </span></label>
                                    </div>

                                    <div class="form-group form-md-line-input">
                                        <div class="md-checkbox">
                                            <input type="checkbox" name="is_default" id="is_default" value="1" @if($notification->is_default == '1') selected @endif class="md-check">
                                    ...
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        <select class="form-control" id="status" name="status" required>
                                            ...
                                            <option value="1" @if($notification->status == '1') selected @endif>Active</option>
                                            <option value="0" @if($notification->status == '0') selected @endif>InActive</option>
                                        </select>
            ...
            var handleValidation3 = function() {
                ...
                form1.validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        error1.hide();
                        $.easyAjax({
                            url: "{{route('gym-admin.notifications.update',$notification->uuid)}}",
