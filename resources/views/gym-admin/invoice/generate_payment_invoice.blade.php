...
@section('CSS')
    ...
    <link rel="stylesheet" href="{{ asset("admin/pages/css/invoice.min.css") }}">
    <link rel="stylesheet" href="{{ asset("admin/global/plugins/ladda/ladda-themeless.min.css") }}">
                    ...
                    <div class="portlet light portlet-fit">
                        ...
                        <div class="portlet-body">
                            <div class="invoice">
                                    ...
                                    <div class="col-xs-12">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <th class="hidden-xs"> Purchase</th>
                                            ...
                                            <?php $discount = ($item->discount_amount != "") ? $item->discount_amount : 0  ?>
                                                <tr>
                                                    ...
                                                    <td class="hidden-xs">{{ $gymSettings->currency->acronym }} {{ $discount }} </td>
                                                    <td class="hidden-xs"> {{ $gymSettings->currency->acronym }} {{ ($item->cost_per_item * $item->quantity) - $discount }} </td>
                                    ...
                                    <div class="col-xs-6 col-md-4">
                                        ...
                                        <div class="">
                                            <address>
                                                ...
                                                @if(!is_null($merchantBusiness->business->phone2))<br>Phone: {{ $merchantBusiness->business->phone2 }} @endif
                                            </address>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <em>Invoice generated by: {{ ucwords($invoice->generated_by) }}</em> <br>
