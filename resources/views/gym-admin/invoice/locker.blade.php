...
@section('content')
    <div class="container-fluid"      >
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span>Locker Payment Invoice</span>
            </li>
        </ul>
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject font-red bold uppercase">Locker Payment Invoices</span>
                            </div>
                            <div class="pull-right">
                                <div class="btn-group">
                                    ...
                                    <a href="{{route('gym-admin.gym-invoice.productIndex')}}" class="btn btn-info"> Product Invoice
                                    </a>
...
@section('footer')
    ...
    <script>
        ...
        function load_dataTable()
        {
            ...
            table.dataTable({
                responsive: true,
                ajax: "{{route('gym-admin.gym-invoice.create',['type'=>'locker'])}}",
                bDestroy:true,
                columns: [
