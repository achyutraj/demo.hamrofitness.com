...
<head>
    ...
    <title>Product Payment Report</title>
    <style>
        table, tr {
...
<div class="col-md-10">
    <h3 style="text-align:left;text-transform: uppercase"> Product Payment Report from {{$sd}} To {{$ed}}</h3>
    ...
    <table class="table table-striped">
        ...
        @foreach($data as $d)
            @php
                $arr['product_name'] = json_decode($d->product_name,true);
