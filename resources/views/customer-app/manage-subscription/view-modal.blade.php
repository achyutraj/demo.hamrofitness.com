                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{ $gymSettings->currency->acronym.' '.$showSubscription->amount_to_be_paid }}</td>
                            <td>{{ $gymSettings->currency->acronym.' '.($showSubscription->amount_to_be_paid - $showSubscription->paid_amount) }}</td>
