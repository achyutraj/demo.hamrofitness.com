                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control select2" name="product_sale_id" id="product_sale_id">
                                        ...
                                        @foreach($purchases as $purchase)
                                            ...
                                            ?>
                                            <option value="{{ $purchase->id }}">{{ $data }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
...
@section('JS')
    ...
    <script>
        ...
        $('#product_sale_id').on('change',function () {
            var purchaseId = $(this).val();
            var url = "{{route('customer-app.product-payments.remainingPayment',[':id'])}}";
