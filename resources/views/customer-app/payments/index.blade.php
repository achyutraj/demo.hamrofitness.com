        ...
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a class="btn btn-sm btn-success waves-effect" href="{{ route('customer-app.payments.create',['id' => null,]) }}"><i class="zmdi zmdi-plus zmdi-hc-fw fa-fw"></i>Add Payment</a>
                    </div>
                    @endif
