            ...
            <div class="white-box p-l-20 p-r-20">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        {{ html()->form->open(['route'=>['customer-app.payments.pay'],'class'=>'form-material form-horizontal','method'=>'POST']) !!}
                        <div class="form-body">
                            <div class="form-group">
                                <label class="col-sm-6">Membership Name</label>
                                <div class="col-sm-6">
                                    <select class="form-control select2" name="purchase_id" id="purchase_id">
                                        <option selected disabled>Select Membership</option>
                                        @foreach($purchases as $purchase)
                                            <option value="{{ $purchase->id }}">{{$purchase->membership->title}} -[Purchased On: {{ $purchase->purchase_date->format('d-M') }}]</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-md" id="modal-data-application">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="{{ route('customer-app.payments.index') }}" class="btn btn-success">Ok</a>
                </div>
            </div>
        </div>
    </div>
...
@section('JS')
    ...
    <script>
        ...
        $('#purchase_id').on('change',function () {
            ...
            var url = "{{route('customer-app.payments.remainingPayment',[':id'])}}";
