...
<head>
    ...
    <meta name="keywords" content="HamroFitness registration, HamroFitness sign up, Fitisgma create account"/>
    <meta property="og:title" content="HamroFitness - Sign Up" />
    ...
    <meta property="og:site_name" content="HamroFitness" />
    ...
    <title> HamroFitness - Create Account</title>
    <!-- Favicon -->
        ...
        <div class="container">
            <div id="login-overlay" class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="ptb-20">
                        <p class="text-center">Copyright &COPY; <a href="http://www.froiden.com">HamroFitness</a>. {{ \Carbon\Carbon::today('Asia/Kathmandu')->year }}. </p>
                    </div>
                </div>
